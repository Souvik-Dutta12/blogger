  ...
  return (
    <div onMouseEnter={() => setActive(item)} className="relative ">
      <motion.p
        ...
        className="cursor-pointer text-black hover:opacity-[0.9] duration-300 hover:text-[#7fcfec] dark:text-white">
        {item}
      </motion.p>
      {active !== null && (
        <motion.div
...
export const HoveredLink = ({
  ...
  return (
    <a
      {...rest}
      className="text-neutral-700 dark:text-neutral-200 hover:text-[#70caeb] ">
      {children}
    </a>
  );
};

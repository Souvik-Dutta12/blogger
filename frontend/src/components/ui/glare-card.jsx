...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className="relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-[120px] h-[100px] md:w-[500px] md:h-[150px] [aspect-ratio:17/21]"
      ref={refElement}
      onPointerMove={(event) => {
      ...
      <div
        ...
        <div
          ...
          <div className={cn("h-auto w-auto bg-[#050809]", className)}>
            {children}
          </div>
        </div>
        <div
